...
namespace ND3ConsoleGame.Maps
{
    class Wave2
    {
        public static int StartHoamingMisslieCount = 6;
        public static int StartMeteoriteCount = 1;
        public static int SpawnMeteoriteTime = Convert.ToInt32(10 / GameObject.GameSpeed);
        public static int SpawnMissileTime = Convert.ToInt32(1 / GameObject.GameSpeed);
        public static int MaxPoints = 250;
